        ...
        function ($http) {
            ...
            service.AllBuildings = function(){
                return [
                  ...
                  {id:'5',number:'5',title:'5#楼',img:'images/Building-green.png'},
          ...
          service.AllRooms = function(){
              return [
                {id:'1',number:'1',title:'203室',img:'images/Apartment-green.png',warn:"欠费"},
                ...
                {id:'6',number:'6',title:'304室',img:'images/Apartment-green.png',warn:"欠费"},
